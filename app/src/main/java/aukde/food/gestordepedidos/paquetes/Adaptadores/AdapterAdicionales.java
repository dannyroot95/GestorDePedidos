...
public class AdapterAdicionales  extends RecyclerView.Adapter<AdapterAdicionales.viewHolderAdicionales> {


    List<ProductoDefault> productoDefaultList;
    Context c;

    public AdapterAdicionales(List<ProductoDefault> productoDefaultList){
    ...
    @NonNull
    @Override
    public AdapterAdicionales.viewHolderAdicionales onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_productos,parent,false);
        AdapterAdicionales.viewHolderAdicionales holder = new AdapterAdicionales.viewHolderAdicionales(view);
        return holder;
    }


    @Override
    public void onBindViewHolder(@NonNull AdapterAdicionales.viewHolderAdicionales holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), DetalleAdicionales.class);
    ...
    public class viewHolderAdicionales extends RecyclerView.ViewHolder

    {
        ...
        public viewHolderAdicionales(@NonNull final View itemView){
            super(itemView);
