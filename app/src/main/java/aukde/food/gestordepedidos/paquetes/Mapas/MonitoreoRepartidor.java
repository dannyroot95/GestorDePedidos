...
public class MonitoreoRepartidor extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveRepartidor(mCurrentLatLng, 100).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(final String key, final GeoLocation location) {
                ...
                mDatabase.child("Monitoreo").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(MonitoreoRepartidor.this, new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
                            }
                        })
                        .create()
                        .show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(MonitoreoRepartidor.this, MenuAdmin.class));
        finish();
    }
}
