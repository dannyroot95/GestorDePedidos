...
import aukde.food.gestordepedidos.paquetes.Adaptadores.AdapterListaPorAukdeliver;
...
public class ListaAukdeliver extends AppCompatActivity {
    ...
    AdapterListaPorAukdeliver adapterListaPorAukdelivery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterListaPorAukdelivery = new AdapterListaPorAukdeliver(listUsuariosAukdeDelivery);
            ...
            mDatabaseReference.child(datos).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
                        ...
                        Toast.makeText(ListaAukdeliver.this, "Sin Usuarios", Toast.LENGTH_SHORT).show();
                        mDialogActualizeData.dismiss();
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(ListaAukdeliver.this, "Error de base de datos", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void buscar(String texto) {
        ...
        AdapterListaPorAukdeliver adapter = new AdapterListaPorAukdeliver(lista);
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(ListaAukdeliver.this, MenuAdmin.class));
        finish();
    }
