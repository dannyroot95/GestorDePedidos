...
public class AdapterListaPorAukdelivery extends RecyclerView.Adapter<AdapterListaPorAukdelivery.viewHolderAukdeDelivery > {
    ...
    public AdapterListaPorAukdelivery(List<ListaAukdelivery> AukdeDeliveryLlamadaList) {
