...
public class Adicionales extends AppCompatActivity {
    ...
    private TextInputEditText edtNombreProducto , edtDescripcionProducto,
            edtTarifaConfidencial, edtTarifaPublicada , edtCodigoINEA ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MiToolbar.Mostrar(this,"Agregar adicionales",false);
        ...
        btnRegProducto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Adicionales.this,R.style.ThemeOverlay);
        ...
        btnAbrirGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()){
                    Toasty.info(Adicionales.this, "Agrege el nombre del producto", Toast.LENGTH_SHORT,true).show();
                }
                else {
                    openGallery();
                }
    ...
    private void clickRegistro() {
        ...
        if (!nombreProducto.isEmpty() && !descripcionProducto.isEmpty() && !tarifaConfidencial.isEmpty()
            ...
            mDatabase.child("Usuarios").child("Proveedor").child(mAuth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mDatabase.child("Usuarios").child("Proveedor").child(mAuth.getUid()).child("Adicionales").push().setValue(map);
                    mDialog.dismiss();
                    finish();
                    Toasty.success(Adicionales.this, "Producto Agregado!", Toast.LENGTH_SHORT).show();
                }
    ...
    private void saveImage(){
        ...
        final StorageReference storage = FirebaseStorage.getInstance().getReference().child("adicionales").child(mAuth.getUid()).child(edtNombreProducto.getText().toString()+".jpg");
        ...
        uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toasty.error(Adicionales.this, "Error al subir imagen", Toast.LENGTH_SHORT,true).show();
                }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Adicionales.this, MenuAddProduct.class);
