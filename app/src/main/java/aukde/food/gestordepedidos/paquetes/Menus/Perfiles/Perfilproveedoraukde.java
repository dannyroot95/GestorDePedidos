...
public class Perfilproveedoraukde extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdateX.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toasty.error(Perfilproveedoraukde.this, "No tiene permisos para cambiar sus nombres", Toast.LENGTH_LONG).show();
            }
        });
                        ...
                        public void onSuccess(final Uri uri) {
                            ...
                            imagestore.updateChildren(fotoMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Glide.with(Perfilproveedoraukde.this)
                                            .load(imageURL)
                                            .into(new CustomTarget<Drawable>() {
                                                ...
                                                public void onResourceReady(@NonNull Drawable resource, @Nullable Transition<? super Drawable> transition) {
                                                    ...
                                                    deleteCache.trimCache(Perfilproveedoraukde.this);
                                                }
                                    ...
                                    mDialog.dismiss();
                                    Toasty.success(Perfilproveedoraukde.this, "Foto de perfil actualizada", Toast.LENGTH_LONG,true).show();
                                }
                            });
                        }
                    });
    ...
    private void getPhotoUsuario(){
        ...
        if(directory.exists()){
            ...
            Glide.with(Perfilproveedoraukde.this).load(toLoad).into(CrMyPhoto);
        }
        else{
            mDatabase.child("Usuarios").child("Proveedor").child(id).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.hasChild("foto")){
                        ...
                        Glide.with(Perfilproveedoraukde.this).load(setFoto).into(CrMyPhoto);
                        String dirPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + getString(R.string.app_name) + "/";
                        final File dir = new File(dirPath);
                        final String fileName = "profile.jpg";
                        Glide.with(Perfilproveedoraukde.this)
        ...
        mDatabase.child("Usuarios").child("Aukdeliver").child(id).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mDatabase.child("Usuarios").child("Proveedor").child(id).updateChildren(datos).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toasty.success(Perfilproveedoraukde.this, "Nombres Actualizados", Toast.LENGTH_SHORT,true).show();
                        ObtenerDataUser();
                        mDialog.dismiss();
                    }
                });
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toasty.error(Perfilproveedoraukde.this, "Hubo un error al actualizar datos", Toast.LENGTH_SHORT,true).show();
            }
        });
    }
    @Override
