...
public class AgregarProductoTortas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapterSpinnerTamano = ArrayAdapter.createFromResource(this,R.
                array.cake,R.layout.custom_spinner);
        ...
        btnRegProducto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AgregarProductoTortas.this,R.style.ThemeOverlay);
        ...
        btnAbrirGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()){
                    Toasty.info(AgregarProductoTortas.this, "Agrege el nombre del producto", Toast.LENGTH_SHORT,true).show();
                }
                else {
                    openGallery();
                }
        ...
        if (!nombreProducto.isEmpty() && !descripcionProducto.isEmpty() && !contenidoProducto.isEmpty() && !stock.isEmpty()
            ...
            mDatabase.child("Usuarios").child("Proveedor").child(mAuth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mDialog.dismiss();
                    finish();
                    Toasty.success(AgregarProductoTortas.this, "Producto Agregado!", Toast.LENGTH_SHORT).show();
                }
        ...
        uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toasty.error(AgregarProductoTortas.this, "Error al subir imagen", Toast.LENGTH_SHORT,true).show();
                }
