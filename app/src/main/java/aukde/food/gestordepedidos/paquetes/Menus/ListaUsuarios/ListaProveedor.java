...
public class ListaProveedor extends AppCompatActivity {
    ...
    ArrayList<aukde.food.gestordepedidos.paquetes.Modelos.ListaProveedor> listUsuariosProveedor;
        ...
        for(final String datos:usersEmpleado){
            ...
            mDatabaseReference.child(datos).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
                        ...
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                            aukde.food.gestordepedidos.paquetes.Modelos.ListaProveedor pd = snapshot.getValue(aukde.food.gestordepedidos.paquetes.Modelos.ListaProveedor.class);
                        ...
                        Toast.makeText(ListaProveedor.this, "Sin Usuarios", Toast.LENGTH_SHORT).show();
                        mDialogActualizeData.dismiss();
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(ListaProveedor.this, "Error de base de datos", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void buscar(String texto) {
        ArrayList<aukde.food.gestordepedidos.paquetes.Modelos.ListaProveedor> lista = new ArrayList<>();
        for(aukde.food.gestordepedidos.paquetes.Modelos.ListaProveedor object : listUsuariosProveedor){
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(ListaProveedor.this, MenuAdmin.class));
        finish();
    }
