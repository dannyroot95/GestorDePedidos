...
public class ListaAdicionales extends AppCompatActivity {
    ...
    AdapterAdicionales adapterProductoDefault;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_adicionales);
        MiToolbar.Mostrar(this,"Lista de adicionales",false);
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("Usuarios").child("Proveedor").child(id).child("Adicionales");
        ...
        adapterProductoDefault = new AdapterAdicionales(listProductos);
        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    Toasty.info(ListaAdicionales.this, "Sin Productos", Toast.LENGTH_SHORT,true).show();
                    mDialogActualizeData.dismiss();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toasty.error(ListaAdicionales.this, "Error de base de datos", Toast.LENGTH_SHORT,true).show();
            }
        });
